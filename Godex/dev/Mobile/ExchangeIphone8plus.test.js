...
test("ExchangeIphone8plus", async () => {
  ...
  await page.screenshot({ path: 'screenshot/iPhone8Plus/status-starting.png' });
  ...
  await expect(page).toHaveText('.c-title', 'Waiting for Deposit');
   await page.screenshot({ path: 'screenshot/iPhone8Plus/status-waiting.png' });
  ...
  await page.screenshot({ path: 'screenshot/iPhone8Plus/status-confirmation.png' });
  ...
  await page.screenshot({ path: 'screenshot/iPhone8Plus/status-exchanging.png' });
  ...
  await page.waitForTimeout(4000);
  await page.screenshot({ path: 'screenshot/iPhone8Plus/status-completed-popup.png' });
  await page.click('.gdx-modal__header-close-button-image')
  await expect(page).toHaveText('.c-title', 'Completed');
  await page.screenshot({ path: 'screenshot/iPhone8Plus/status-completed.png' });
