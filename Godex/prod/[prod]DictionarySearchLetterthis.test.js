...
test("DictionarySearchLetterDev", async () => {
     ...
     await expect(page).toHaveText ('.dictionary-item__title', 'KYC');
     await page.click("css=.dictionary__letters-wrapper >> text=L");
     await page.waitForTimeout(1000);
     await page.click("div:nth-of-type(13)");
     await page.waitForTimeout(1000);
     await expect(page).toHaveText ('.dictionary-item__title','Lambo');
